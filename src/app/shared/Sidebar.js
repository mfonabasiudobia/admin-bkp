  ...
  render() {
    ...
    return (
      ...
      <nav className="sidebar sidebar-offcanvas" id="sidebar" style={{
        ...
        {/* <div className="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top" style={{
          ...
          <div className="sidebar-brand-text font-weight-bold" style={{ marginLeft: '1rem' }}>
            <h3 style={{ 
              color: 'white', 
              margin: 0,
              fontSize: '1.5rem',
              ...
              {this.props.usertype === 'Agent' ? 'AGENT PANEL' : 'ADMIN PANEL'}
            </h3>
          </div>
        </div> */}
        <ul className="nav">
          <li className={this.isPathActive('/admin/profile') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
            <Link className="nav-link" to="/admin/profile" style={{
              color: this.isPathActive('/admin/profile') ? 'white' : '#cbd5e1',
              borderRadius: '8px',
              margin: '0 0.5rem 2rem',
              padding: '0.75rem 1rem',
              transition: 'all 0.3s ease',
              background: this.isPathActive('/admin/profile') ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'transparent',
              boxShadow: this.isPathActive('/admin/profile') ? '0 4px 6px rgba(99, 102, 241, 0.3)' : 'none'
            }}>
              ...
              <span className="menu-title" style={{ fontWeight: '500' }}>
                <Trans>User: {this.props.usertype ? this.props.usertype : ''}</Trans>
              </span>
            </Link>
          </li>
           ...
           (
            <li className={this.isPathActive('/dashboard') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
              <Link className="nav-link" to="/dashboard" style={{
                color: this.isPathActive('/dashboard') ? 'white' : '#cbd5e1',
                borderRadius: '8px',
                margin: '0 0.5rem',
                padding: '0.75rem 1rem',
                transition: 'all 0.3s ease',
                background: this.isPathActive('/dashboard') ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'transparent',
                boxShadow: this.isPathActive('/dashboard') ? '0 4px 6px rgba(99, 102, 241, 0.3)' : 'none'
              }}>
                <span className="menu-icon" style={{ marginRight: '0.75rem' }}>
          ...
          {this.props.earnings && (
            <li className={this.isPathActive('/earinigs') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
              <Link className="nav-link" to="/earinigs" style={{
                color: this.isPathActive('/earinigs') ? 'white' : '#cbd5e1',
                borderRadius: '8px',
                margin: '0 0.5rem',
                padding: '0.75rem 1rem',
                transition: 'all 0.3s ease',
                background: this.isPathActive('/earinigs') ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'transparent',
                boxShadow: this.isPathActive('/earinigs') ? '0 4px 6px rgba(99, 102, 241, 0.3)' : 'none'
              }}>
                <span className="menu-icon" style={{ marginRight: '0.75rem' }}>
          ...
          {(this.props.allAdmins || this.props.newAdmin || this.props.sitesettings || this.props.twilioConfig) && (
            <li className={this.isPathActive('/admin') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
              <div className={this.state.adminMenu ? 'nav-link menu-expanded' : 'nav-link'} onClick={() => this.toggleMenuState('adminMenu')} data-toggle="collapse" style={{
                color: this.isPathActive('/admin') ? 'white' : '#cbd5e1',
                borderRadius: '8px',
                margin: '0 0.5rem',
                padding: '0.75rem 1rem',
                transition: 'all 0.3s ease',
                background: this.isPathActive('/admin') ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'transparent',
                boxShadow: this.isPathActive('/admin') ? '0 4px 6px rgba(99, 102, 241, 0.3)' : 'none',
                cursor: 'pointer'
              }}>
                <span className="menu-icon" style={{ marginRight: '0.75rem' }}>
          ...
          {(this.props.allUsers || this.props.newUser || this.props.pendingKyc || this.props.completedKyc || this.props.rejectKyc) && (
            <li className={this.isPathActive('/user') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
              <div className={this.state.userMenu ? 'nav-link menu-expanded' : 'nav-link'} onClick={() => this.toggleMenuState('userMenu')} data-toggle="collapse" style={{
                color: this.isPathActive('/user') ? 'white' : '#cbd5e1',
                borderRadius: '8px',
                margin: '0 0.5rem',
                padding: '0.75rem 1rem',
                transition: 'all 0.3s ease',
                background: this.isPathActive('/user') ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'transparent',
                boxShadow: this.isPathActive('/user') ? '0 4px 6px rgba(99, 102, 241, 0.3)' : 'none',
                cursor: 'pointer'
              }}>
                <span className="menu-icon" style={{ marginRight: '0.75rem' }}>
          ...
          {(this.props.allChallenges || this.props.completedChallenges || this.props.conflictChallenges || this.props.cancelledChallenges || this.props.runningChallenges || this.props.newChallenge || this.props.dropChallenge) && (
            <li className={this.isPathActive('/challenge') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
              <div className={this.state.challengeMenu ? 'nav-link menu-expanded' : 'nav-link'} onClick={() => this.toggleMenuState('challengeMenu')} data-toggle="collapse" style={{
                color: this.isPathActive('/challenge') ? 'white' : '#cbd5e1',
                borderRadius: '8px',
                margin: '0 0.5rem',
                padding: '0.75rem 1rem',
                transition: 'all 0.3s ease',
                background: this.isPathActive('/challenge') ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'transparent',
                boxShadow: this.isPathActive('/challenge') ? '0 4px 6px rgba(99, 102, 241, 0.3)' : 'none',
                cursor: 'pointer'
              }}>
                <span className="menu-icon" style={{ marginRight: '0.75rem' }}>
          ...
          {(this.props.penaltyBonus || this.props.depositHistory || this.props.withdrawlHistory || this.props.allWithdrawlRequests || this.props.allDepositRequests) && (
            <li className={this.isPathActive('/transaction') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
              <div className={this.state.transactionMenu ? 'nav-link menu-expanded' : 'nav-link'} onClick={() => this.toggleMenuState('transactionMenu')} data-toggle="collapse" style={{
                color: this.isPathActive('/transaction') ? 'white' : '#cbd5e1',
                borderRadius: '8px',
                margin: '0 0.5rem',
                padding: '0.75rem 1rem',
                transition: 'all 0.3s ease',
                background: this.isPathActive('/transaction') ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'transparent',
                boxShadow: this.isPathActive('/transaction') ? '0 4px 6px rgba(99, 102, 241, 0.3)' : 'none',
                cursor: 'pointer'
              }}>
                <span className="menu-icon" style={{ marginRight: '0.75rem' }}>
          ...
          {(this.props.bonusReport || this.props.depositReport || this.props.penaltyReport || this.props.withdrawlReport) && (
            <li className={this.isPathActive('/reports') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
              <div className={this.state.reportsMenu ? 'nav-link menu-expanded' : 'nav-link'} onClick={() => this.toggleMenuState('reportsMenu')} data-toggle="collapse" style={{
                color: this.isPathActive('/reports') ? 'white' : '#cbd5e1',
                borderRadius: '8px',
                margin: '0 0.5rem',
                padding: '0.75rem 1rem',
                transition: 'all 0.3s ease',
                background: this.isPathActive('/reports') ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'transparent',
                boxShadow: this.isPathActive('/reports') ? '0 4px 6px rgba(99, 102, 241, 0.3)' : 'none',
                cursor: 'pointer'
              }}>
                <span className="menu-icon" style={{ marginRight: '0.75rem' }}>
